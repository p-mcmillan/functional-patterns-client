  ...
  return (
    <div className="flex flex-col items-center px-[15px] py-[80px] text-center">
      <Helmet>
        ...
        <meta
          name="url"
          content="https://nycbiomechanics.com/practitioners/brent-mcmillan"
        />
        ...
        <meta
          name="twitter:title"
          content="Brent McMillan - NYC Biomechanics"
        />
        ...
        <link
          rel="canonical"
          href="https://nycbiomechanics.com/practitioners/brent-mcmillan"
        />
      </Helmet>
      <div className="my-5">
