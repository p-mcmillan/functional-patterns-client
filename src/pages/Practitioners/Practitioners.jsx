  ...
  return (
    <div className="flex flex-col items-center px-[15px] py-[80px] text-center min-h-screen mb-[80px]">
      <Helmet>
        ...
        <meta
          name="url"
          content="https://www.nycbiomechanics.com/practitioners"
        />

        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Practitioners - NYC Biomechanics - Functional Patterns Training in NYC"
        />
        <meta
        ...
        <link
          rel="canonical"
          href="https://www.nycbiomechanics.com/practitioners"
        />
      </Helmet>
      <h2 className="py-5 text-center text-black uppercase mb-4 px-6 lg:text-[35px]">
