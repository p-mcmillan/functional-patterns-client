...
const GetStarted = () => {
  ...
  return (
    <div className="flex flex-col items-center px-[15px] py-[80px] text-center lg:pt-[200px] mt-[20px]">
      ...
      <h2 className="lg:text-[36px]">What You Can Anticipate from Your Initial Assessment*</h2>
      <div className=" flex flex-wrap justify-center">
        <div className="flex flex-col items-center p-[30px] max-w-[395px]">
          ...
          <div className="text-center text-[16px] lg:text-[18px]">
            <p className="mb-[16px]">
              Discover why practitioners of Functional Patterns worldwide are achieving unmatched results in the fitness
        ...
        <div className="flex flex-col items-center p-[30px] max-w-[395px] ">
          ...
          <div className="my-[20px]">
            <h2 className="mt-[6px] mb-[5px] text-center">2. Discussion on Your Background, Pain, and Any Injuries</h2>
          </div>
          <div className="text-center text-[16px] lg:text-[18px]">
            <p className="mb-[16px]">
              We&apos;ll delve into your background and daily routines to identify key factors contributing to your
              issues or those impeding your progress toward your health and fitness objectives.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center p-[30px] max-w-[395px]">
          ...
          <div className="my-[20px]">
            <h2 className="mt-[6px] mb-[5px] text-center">
              3. Thorough Analysis of Your Posture and Walking Pattern (Gait Cycle)
            </h2>
          </div>
          <div className="text-center text-[16px] lg:text-[18px]">
            <p className="mb-[16px]">
              To assess your movement inefficiencies effectively, we&apos;ll capture photographs of your standing
              posture from both sides and utilize slow-motion technology to record your gait cycle.
            </p>
            <p className="mb-[16px]">
              Together, we&apos;ll review these findings and demonstrate how the Functional Patterns system addresses
              these inefficiencies, empowering you to enhance your health and overcome pain.
            </p>
          </div>
        </div>
      </div>{' '}
