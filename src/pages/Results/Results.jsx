...
const Results = (props) => {
  ...
  return (
    <div className="lg:pt-40 pt-20  bg-gradient-to-t from-[#1c1917] from-10% via-[#1c1917] via-30%   to-[#0c0a09] to-80%">
      <Helmet>
        <meta charset="UTF-8" />
        <title>Results - NYC Biomechanics</title>
        ...
        <meta name="url" content="https://nycbiomechanics.com/results" />

        <meta property="og:type" content="website" />
        <meta property="og:title" content="Results - NYC Biomechanics" />
        <meta
          property="og:description"
          content="Unlock pain-free movement with our unique biomechanics training program in NYC. Experience greater mobility, strength, and flexibility. Join us today!"
        />
        <meta property="og:image" content="/image-black.png" />
        <meta property="og:url" content="https://nycbiomechanics.com/results" />
