...
const ResultsMain = ({ resultsMainRef, videoHeroData }) => {
  ...
  return (
    <div ref={resultsMainRef} className=" snap-center relative flex justify-center items-center bg-black h-screen ">
      {/* Video Container Mobile*/}
      <video
        className="block md:hidden w-full h-screen object-cover grayscale"
        src="https://res.cloudinary.com/dprfd8p6y/video/upload/q_46/v1712764738/nyc-biomechanics/videos/Results-Mainccfbddc2_gtigbg.mp4"
        autoPlay
        loop
        muted
      ...
      <video
        src="https://res.cloudinary.com/dprfd8p6y/video/upload/f_auto:video,q_auto/v1/nyc-biomechanics/videos/home02_bkohva"
        autoPlay
        loop
        muted
        playsInline // Play inline on iOS
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
        <h1 className="py-5 text-center text-white uppercase mb-4 px-6">reprogram muscles using pain free movement</h1>
