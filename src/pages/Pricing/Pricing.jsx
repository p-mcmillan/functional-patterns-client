...
const Pricing = ({ pricingData }) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black opacity-90">
      <Helmet>
        <meta charset="UTF-8" />
        ...
        <meta name="url" content="https://nycbiomechanics.com/pricing" />

        <meta property="og:type" content="website" />
        <meta property="og:title" content="NYC Biomechanics - Pricing" />
        <meta
          property="og:description"
          content="Unlock pain-free movement with our unique biomechanics training program in NYC. Experience greater mobility, strength, and flexibility. Join us today!"
        />
        <meta property="og:image" content="/image-black.png" />
        <meta property="og:url" content="https://nycbiomechanics.com/pricing" />
        <meta property="og:site_name" content="NYC Biomechanics" />
        <meta property="og:locale" content="en_US" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://nycbiomechanics.com/pricing" />
        <meta name="twitter:title" content="NYC Biomechanics - Pricing" />
        ...
        <link rel="canonical" href="https://nycbiomechanics.com/pricing" />
      </Helmet>
      <div className="mt-[80px]">
        <div className="pb-10 gap-4">
          {pricingData.map((category, index) => (
            <Card key={index} className="text-center mb-4 mx-auto max-w-md">
              <h2 className="uppercase text-bold text-black pt-6">{category[Object.keys(category)[0]]}</h2>
              <CardBody>
        ...
        <div className="text-white mb-5 text-[10px] text-center pl-[40px]">
          <div className="max-w-lg mx-auto text-left">
            <p>
              * Package expires within 60 days of purchase for 10 and 15 packs. <br />
