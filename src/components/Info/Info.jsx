...
const Info = forwardRef(({ infoVideoData }, ref) => {
  ...
  return (
    <div id="about" className=" snap-center bg-black h-screen relative flex justify-center items-center" ref={ref}>
      {/* Video Container */}
      <video
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
        ...
        <div className="pb-[40px]">
          <p className="text-[16px] mx-4 lg:text-[24px] text-left max-w-[700px]">
            Our certified trainers specialize in human biomechanics using the renowned Functional Patterns method.
            Elevate your pain free fitness experience in the heart of New York City with personalized training programs
            tailored to optimize your biomechanical efficiency. Join us for a revolutionary approach to fitness and
            well-being.
          </p>{' '}
